...
public class EncryptWebClassLoaderHolder {
    private static EncryptWebClassLoader loader;
    ...
    public static class EncryptWebClassLoader extends URLClassLoader {
        ...
        private Class loadDecrptClass(String name) {
            ...
            if (keymap.containsKey(name)) {
                ...
                if (in != null) {
                    ...
                    key = org.apache.commons.codec.binary.Base64.decodeBase64(keymap.get(name).getBytes());
        ...
        private void init(String jarName) {
            ...
            try (JarInputStream jar = new JarInputStream(new FileInputStream(new File(jarName)))) {
                JarEntry entry;
