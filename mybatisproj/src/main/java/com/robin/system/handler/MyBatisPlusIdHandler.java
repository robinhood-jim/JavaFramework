package com.robin.system.handler;
...
public class MyBatisPlusIdHandler implements MetaObjectHandler {
   ...
   /* public MyBatisPlusIdHandler(IdGenerator idGenerator) {
    ...
    public void insertFill(MetaObject metaObject) {
        ...
        if (metaObject.hasSetter(CREATOR) && metaObject.hasSetter(MODIFIER)
            ...
            try {
                if (SecurityUtils.getLoginUser() != null) {
                    ...
                    Long tenantId =SecurityUtils.getLoginUser().getTenantId();//SecurityUtils.getLoginUser().getUser().getTenantId();
        ...
        setFieldValByNameIfNull(STATUS, Const.VALID, metaObject);
    }
