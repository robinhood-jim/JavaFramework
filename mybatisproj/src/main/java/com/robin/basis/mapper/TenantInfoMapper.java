...
public interface TenantInfoMapper extends BaseMapper<TenantInfo> {
    @Select("<script>"
            +"select a.user_id as userId,b.id as id,b.tenant_name as tenantName,b.tenant_code as tenantCode,b.org_id as orgId,c.org_name as orgName,c.org_code as orgCode,a.type from t_tenant_user_r a,t_tenant_info b,t_sys_org_info c "
