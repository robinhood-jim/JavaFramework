    ...
    <PageWrapper>
        ...
        <MoneyForm :money-crud="moneyCrud" :rules="rules">
            <el-form-item label="字典名称" prop="dictName">
                <el-input v-model.trim="moneyCrud.form.enName" />
            </el-form-item>
        ...
        <MoneyForm :money-crud="moneyCrud2" :rules="rules2">
            ...
            <el-form-item label="字典值" prop="value">
                <el-input v-model.trim="moneyCrud2.form.itemValue" />
            </el-form-item>
            <el-form-item label="中文描述" prop="cnDesc">
                <el-input v-model.trim="moneyCrud2.form.itemName" />
            </el-form-item>
            <!-- TODO 多语言 -->
            ...
            <el-form-item label="隐藏" prop="hidden">
                <el-radio-group v-model="moneyCrud2.form.status">
            ...
            <el-form-item label="排序" prop="sort">
                <el-input-number v-model.number="moneyCrud2.form.orderNo" :min="0" :max="999" controls-position="right" />
            </el-form-item>
        </MoneyForm>
    </PageWrapper>
</template>
...
const columns = [
    {prop: 'enName', label: '字典名称'},
    {prop: 'cnName', label: '字典描述'},
    {
        prop: 'opt',
        label: '操作',
        width: 120,
...
const rules = {
    enName: [{required: true, message: '请输入字典名称'}]
}
...
const columns2 = [
    {prop: 'itemValue', label: '字典值'},
    {prop: 'itemName', label: '中文描述'},
    // TODO 多语言

    {prop: 'status', label: '隐藏'},
    {prop: 'orderNo', label: '排序', sortable: true},
    {
        prop: 'opt',
        label: '操作',
        width: 120,
