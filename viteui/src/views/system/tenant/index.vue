...
const moneyCrud = ref(new MoneyCrud({
    ...
    optShow: {
        checkbox: userStore.isPlatformAdmin(),
        add: userStore.isPlatformAdmin(),
        edit: userStore.isPlatformAdmin(),
        del: userStore.isPlatformAdmin()
    },
    rowOptDisabled: {
      checkbox: (row) => row.status,
      edit: (row) => !userStore.isPlatformAdmin(),
      del: (row) => !userStore.isPlatformAdmin()
    },
    msg: {
