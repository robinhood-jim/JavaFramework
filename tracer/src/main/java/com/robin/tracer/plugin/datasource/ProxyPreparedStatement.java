...
public class ProxyPreparedStatement extends AbstractSpringAwareJdbcOperation implements PreparedStatement {
    private PreparedStatement delegate;

    public ProxyPreparedStatement(PreparedStatement preparedStatement,String sql,Tracing tracing,TraceParam param){
    ...
    public void setBlob(int parameterIndex, Blob x) throws SQLException {
        ...
        setParameter(parameterIndex,"BLOB Object");
    }

    @Override
    public void setClob(int parameterIndex, Clob x) throws SQLException {
        delegate.setClob(parameterIndex,x);
        setParameter(parameterIndex,"CLOB Object");
    }
    ...
    public void setURL(int parameterIndex, URL x) throws SQLException {
        ...
        setParameter(parameterIndex,x.getPath());
    }
    ...
    public void setSQLXML(int parameterIndex, SQLXML xmlObject) throws SQLException {
        ...
        setParameter(parameterIndex,xmlObject.toString());
    }
    ...
    public ResultSet executeQuery() throws SQLException {
        return (ResultSet) TracingUtils.executeSqlOperationWithSpan(this,"executeQuery",null,this::constructDefault,this::executeQueryDeletgate);
    }
    @Override
    ...
    public int executeUpdate() throws SQLException {
        return (Integer) TracingUtils.executeSqlOperationWithSpan(this,"executeUpdate",null,this::constructDefault,this::executeUpdateDelegate);
    }
    @Override
    ...
    public boolean execute() throws SQLException {
        return (Boolean) TracingUtils.executeSqlOperationWithSpan(this,"execute",null,this::constructDefault,this::executeDelegate);
    }
    @Override
