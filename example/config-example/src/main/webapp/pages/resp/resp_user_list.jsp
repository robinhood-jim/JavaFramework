...
<script type="text/javascript">
    ...
    var queryUrl = ctx + "system/responsiblity/listuser";
    var userFrm = [
        {
    ...
    myForm.setItemValue("respId",selectResp);


    myForm.attachEvent("onButtonClick", function (name) {
        if (name == 'submit') {
            this.send(ctx + "system/responsiblity/listUser", function (loader, response) {
