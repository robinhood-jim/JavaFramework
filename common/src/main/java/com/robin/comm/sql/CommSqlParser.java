...
public class CommSqlParser {
    //private static final RelDataTypeFactory relDataTypeFactory;
    ...
    private static SqlSelect parseWithLex(String sql, Lex lex, DataCollectionMeta meta) throws SqlParseException, ValidationException {
        ...
        SqlNode validate=planner.validate(tNodes);
    ...
    private static void parseWhereParts(SqlSegment segment,SqlNode whereNode){
